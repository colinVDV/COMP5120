...
public class DatabaseGui extends JFrame implements ActionListener {
	...
	// Fonts
	private Font titleFont = new Font(Font.SANS_SERIF, 
									  Font.BOLD, 
									  35); // for the app title

	private Font labelFont = new Font(Font.SANS_SERIF,
									  Font.BOLD,
									  18);
	
	private Font buttonFont = new Font(Font.SANS_SERIF,
									   Font.BOLD,
									   14);

	private Font componentFont = new Font(Font.SANS_SERIF,
										  Font.PLAIN,
	...
	DatabaseGui(String dbNameIn, String dbPortIn, String userIn, String pwIn) {
		...
		super("Database Systems: Group 1 Final Project");
